(function()
{
	...
	Sidebar.prototype.addAzure2AIMachineLearningPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'AI_Studio.svg;',
				r * 0.16, r * 0.17, '', 'AI Studio', null, null, this.getTagsForStencil(gn, 'ai studio', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Anomaly_Detector.svg;',
			...
			this.createVertexTemplateEntry(s + 'Bonsai.svg;',
			...
			this.createVertexTemplateEntry(s + 'Computer_Vision.svg;',
					r * 0.17, r * 0.17, '', 'Computer Vision', null, null, this.getTagsForStencil(gn, 'computer vision', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/Search_Services.svg;',
			...
			this.createVertexTemplateEntry(s + 'Content_Moderators.svg;',
					r * 0.17, r * 0.157, '', 'Content Moderators', null, null, this.getTagsForStencil(gn, 'content moderators', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Custom_Vision.svg;',
			...
			this.createVertexTemplateEntry(s + 'Immersive_Readers.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/compute/Metrics_Advisor.svg;',
	...
	Sidebar.prototype.addAzure2AnalyticsPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/databases/Azure_Data_Explorer_Clusters.svg;',
					r * 0.17, r * 0.17, '', 'Data Explorer Clusters', null, null, this.getTagsForStencil(gn, 'data explorer clusters', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/databases/Data_Factory.svg;',
			...
			this.createVertexTemplateEntry(s + 'Power_BI_Embedded.svg;',
					r * 0.1275, r * 0.17, '', 'Power BI Embedded', null, null, this.getTagsForStencil(gn, 'power bi embedded', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Power_Platform.svg;',
					r * 0.1623, r * 0.17, '', 'Power Platform', null, null, this.getTagsForStencil(gn, 'power platform', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/networking/Private_Link_Hub.svg;',
	...
	Sidebar.prototype.addAzure2ComputePalette = function(gn, r, sb, s)
	{
		...
		[
			this.createVertexTemplateEntry(s + 'App_Services.svg;',
					r * 0.16, r * 0.16, '', 'App Services', null, null, this.getTagsForStencil(gn, 'app services', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Application_Group.svg;',
			...
			this.createVertexTemplateEntry(s + 'Host_Pools.svg;',
			...
			this.createVertexTemplateEntry(s + 'Workspaces2.svg;',
	...
	Sidebar.prototype.addAzure2ContainersPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Service_Fabric_Clusters.svg;',
					r * 0.1675, r * 0.16, '', 'Service Fabric Clusters', null, null, this.getTagsForStencil(gn, 'service fabric clusters', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_Red_Hat_OpenShift.svg;',
	...
	Sidebar.prototype.addAzure2DatabasesPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Oracle_Database.svg;',
	...
	Sidebar.prototype.addAzure2DevOpsPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'API_Connections.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/API_Management_Services.svg;',
					r * 0.1625, r * 0.15, '', 'API Management Services', null, null, this.getTagsForStencil(gn, 'api application programming interface management services', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'Change_Analysis.svg;',
			...
			this.createVertexTemplateEntry(s + 'Code_Optimization.svg;',
			...
			this.createVertexTemplateEntry(s + 'DevOps_Starter.svg;',
			...
			this.createVertexTemplateEntry(s + 'Lab_Accounts.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/other/Load_Testing.svg;',
	...
	Sidebar.prototype.addAzure2GeneralPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Dashboard2.svg;',
					r * 0.17, r * 0.12, '', 'Dashboard', null, null, this.getTagsForStencil(gn, 'dashboard', dt).join(' ')),
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/other/Marketplace_Management.svg;',
	...
	Sidebar.prototype.addAzure2IdentityPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Active_Directory_Connect_Health2.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/intune/Azure_AD_Roles_and_Administrators.svg;',
					r * 0.17, r * 0.17, '', 'AD Roles and Administrators', null, null, this.getTagsForStencil(gn, 'ad roles administrators', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Administrative_Units.svg;',
					r * 0.17, r * 0.17, '', 'Administrative Units', null, null, this.getTagsForStencil(gn, 'administrative units', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/other/API_Proxy.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_AD_B2C2.svg;',
			...
			this.createVertexTemplateEntry(s + 'Entra_Verified_ID.svg;',
				r * 0.17, r * 0.1511, '', 'Entra Verified ID', null, null, this.getTagsForStencil(gn, 'entra verified id', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'External_Identities.svg;',
			...
			this.createVertexTemplateEntry(s + 'User_Settings.svg;',
			...
			this.createVertexTemplateEntry(s + 'Verification_As_A_Service.svg;',
	...
	Sidebar.prototype.addAzure2IntegrationPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/devops/API_Connections.svg;',
					r * 0.17, r * 0.1133, '', 'API Connections', null, null, this.getTagsForStencil(gn, 'api connections application programming interface', dt).join(' ')),
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/databases/Data_Factory.svg;',
					r * 0.17, r * 0.17, '', 'Data Factories', null, null, this.getTagsForStencil(gn, 'data factories', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/storage/Azure_Stack_Edge.svg;',
			...
			this.createVertexTemplateEntry(s + 'Integration_Environments.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/internet_of_things/Logic_Apps.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Power_Platform.svg;',
					r * 0.1623, r * 0.17, '', 'Power Platform', null, null, this.getTagsForStencil(gn, 'power platform', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'SQL_Data_Warehouses.svg;',
					r * 0.16, r * 0.1625, '', 'SQL Data Warehouses', null, null, this.getTagsForStencil(gn, 'sql data warehouses', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/storage/Data_Box_Edge.svg;',
					r * 0.17, r * 0.1218, '', 'Stack Edge', null, null, this.getTagsForStencil(gn, 'stack edge', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/storage/StorSimple_Device_Managers.svg;',
	...
	Sidebar.prototype.addAzure2IOTPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/databases/Azure_Cosmos_DB.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/integration/Event_Grid_Domains.svg;',
					r * 0.1675, r * 0.15, '', 'Event Grid Subscriptions', null, null, this.getTagsForStencil(gn, 'event grid subscriptions', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Event_Hub_Clusters.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_IoT_Operations.svg;',
					r * 0.17, r * 0.1606, '', 'IoT Operations', null, null, this.getTagsForStencil(gn, 'operations', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/internet_of_things/Logic_Apps.svg;',
					r * 0.17, r * 0.17, '', 'Logic Apps', null, null, this.getTagsForStencil(gn, 'logic apps', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Logic_Apps.svg;',
					r * 0.1675, r * 0.13, '', 'Logic Apps', null, null, this.getTagsForStencil(gn, 'logic apps', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/ai_machine_learning/Machine_Learning_Studio_Classic_Web_Services.svg;',
					r * 0.17, r * 0.17, '', 'Machine Learning Studio - Classic Web Services', null, null, this.getTagsForStencil(gn, 'studio classic web services', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/ai_machine_learning/Machine_Learning_Studio_Web_Service_Plans.svg;',
					r * 0.17, r * 0.17, '', 'Machine Learning Studio - Web Service Plans', null, null, this.getTagsForStencil(gn, 'studio web service plans', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/ai_machine_learning/Machine_Learning_Studio_Workspaces.svg;',
					r * 0.17, r * 0.17, '', 'Machine Learning Studio - Workspaces', null, null, this.getTagsForStencil(gn, 'studio workspaces', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'Notification_Hubs.svg;',
					r * 0.1675, r * 0.14, '', 'Notification Hubs', null, null, this.getTagsForStencil(gn, 'notification hubs', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/azure_stack/Azure_Stack.svg;',
					r * 0.1647, r * 0.17, '', 'Stack', null, null, this.getTagsForStencil(gn, 'stack', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/iot/Azure_Stack_HCI_Sizer.svg;',
					r * 0.17, r * 0.17, '', 'Stack HCI Sizer', null, null, this.getTagsForStencil(gn, 'stack hci sizer', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/iot/Stack_HCI_Premium.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/internet_of_things/Time_Series_Insights_Access_Policies.svg;',
	...
	Sidebar.prototype.addAzure2ManagementGovernancePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry(s + 'Arc_Machines.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/other/Intune_Trends.svg;',
			...
			this.createVertexTemplateEntry(s + 'Resources_Provider.svg;',
	...
	Sidebar.prototype.addAzure2MigratePalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/databases/Azure_Database_Migration_Services.svg;',
					r * 0.16, r * 0.1725, '', 'Database Migration Services', null, null, this.getTagsForStencil(gn, 'migration services', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/storage/Azure_Stack_Edge.svg;',
					r * 0.17, r * 0.12, '', 'Databox Gateway', null, null, this.getTagsForStencil(gn, 'databox gateway', dt).join(' ')),
	...
	Sidebar.prototype.addAzure2MobilePalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/App_Services.svg;',
					r * 0.16, r * 0.16, '', 'App Services', null, null, this.getTagsForStencil(gn, 'app services', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/Notification_Hubs.svg;',
					r * 0.1675, r * 0.14, '', 'Notification Hubs', null, null, this.getTagsForStencil(gn, 'notification hubs', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Power_Platform.svg;',
					r * 0.1623, r * 0.17, '', 'Power Platform', null, null, this.getTagsForStencil(gn, 'power platform', dt).join(' '))
		];
	...
	Sidebar.prototype.addAzure2MonitorPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/management_governance/Activity_Log.svg;',
					r * 0.14, r * 0.1675, '', 'Activity Log', null, null, this.getTagsForStencil(gn, 'activity log', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/devops/Application_Insights.svg;',
					r * 0.11, r * 0.1575, '', 'Application Insights', null, null, this.getTagsForStencil(gn, 'application insights', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/devops/Change_Analysis.svg;',
					r * 0.17, r * 0.1692, '', 'Change Analysis', null, null, this.getTagsForStencil(gn, 'change analysis', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/management_governance/Diagnostics_Settings.svg;',
					r * 0.14, r * 0.1675, '', 'Diagnostics Settings', null, null, this.getTagsForStencil(gn, 'diagnostics settings', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Log_Analytics_Workspaces.svg;',
					r * 0.16, r * 0.16, '', 'Log Analytics Workspaces', null, null, this.getTagsForStencil(gn, 'log analytics workspaces', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/management_governance/Metrics.svg;',
					r * 0.16, r * 0.17, '', 'Metrics Advisor', null, null, this.getTagsForStencil(gn, 'metrics advisor', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/management_governance/Monitor.svg;',
					r * 0.16, r * 0.16, '', 'Monitor', null, null, this.getTagsForStencil(gn, 'monitor', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/networking/Network_Watcher.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/general/Scale.svg;',
					r * 0.17, r * 0.17, '', 'Scale', null, null, this.getTagsForStencil(gn, 'scale', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/analytics/Azure_Workbooks.svg;',
					r * 0.17, r * 0.17, '', 'Workbooks', null, null, this.getTagsForStencil(gn, 'workbooks', dt).join(' '))
		];
	...
	Sidebar.prototype.addAzure2NetworkingPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'Application_Gateway_Containers.svg;',
			...
			this.createVertexTemplateEntry(s + 'ATM_Multistack.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Communications_Gateway.svg;',
					r * 0.17, r * 0.17, '', 'Communications Gateway', null, null, this.getTagsForStencil(gn, 'communications gateway', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/other/Connected_Cache.svg;',
			...
			this.createVertexTemplateEntry(s + 'DNS_Multistack.svg;',
			...
			this.createVertexTemplateEntry(s + 'DNS_Security_Policy.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Firewall_Policy.svg;',
			...
			this.createVertexTemplateEntry(s + 'IP_Address_Manager.svg;',
			...
			this.createVertexTemplateEntry(s + 'Virtual_WAN_Hub.svg;',
	...
	Sidebar.prototype.addAzure2OtherPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry(s + 'Azure_A.svg;',
					r * 0.17, r * 0.1603, '', 'A', null, null, this.getTagsForStencil(gn, '', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/AAD_Licenses.svg;',
			...
			this.createVertexTemplateEntry(s + 'AKS_Automatic.svg;',
					r * 0.17, r * 0.17, '', 'AKS Automatic', null, null, this.getTagsForStencil(gn, 'aks automatic', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'AKS_Istio.svg;',
			...
			this.createVertexTemplateEntry(s + 'App_Compliance_Automation.svg;',
					r * 0.17, r * 0.1237, '', 'App Compliance Automation', null, null, this.getTagsForStencil(gn, 'app compliance automation', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/App_Registrations.svg;',
					r * 0.1673, r * 0.17, '', 'App Registrations', null, null, this.getTagsForStencil(gn, 'app registrations', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'App_Space_Component.svg;',
			...
			this.createVertexTemplateEntry(s + 'Backup_Vault.svg;',
			...
			this.createVertexTemplateEntry(s + 'Compute_Fleet.svg;',
					r * 0.17, r * 0.17, '', 'Compute Fleet', null, null, this.getTagsForStencil(gn, 'compute fleet', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/compute/Azure_Compute_Galleries.svg;',
					r * 0.17, r * 0.17, '', 'Compute Galleries', null, null, this.getTagsForStencil(gn, 'compute galleries', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'Cost_Export.svg;',
			...
			this.createVertexTemplateEntry(s + 'Data_Collection_Rules.svg;',
					r * 0.1665, r * 0.17, '', 'Data Collection Rules', null, null, this.getTagsForStencil(gn, 'data collection rules', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Database_Instance_for_SAP.svg;',
			...
			this.createVertexTemplateEntry(s + 'Defender_Industrial_Printer.svg;',
					r * 0.17, r * 0.17, '', 'Defender Industrial Printer', null, null, this.getTagsForStencil(gn, 'defender industrial printer', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Defender_Industrial_Scale_System.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Dev_Tunnels.svg;',
			...
			this.createVertexTemplateEntry(s + 'Elastic_SAN.svg;',
					r * 0.17, r * 0.17, '', 'Elastic SAN', null, null, this.getTagsForStencil(gn, 'elastic san', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/Active_Directory_Connect_Health2.svg;',
					r * 0.17, r * 0.1511, '', 'Entra Connect Health', null, null, this.getTagsForStencil(gn, 'entra connect health', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Entra_Connect_Sync.svg;',
					r * 0.17, r * 0.17, '', 'Entra Connect Sync', null, null, this.getTagsForStencil(gn, 'entra connect sync', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Entra_Identity.svg;',
			...
			this.createVertexTemplateEntry(s + 'Express_Route_Traffic_Collector.svg;',
			...
			this.createVertexTemplateEntry(s + 'FHIR_Service.svg;',
			...
			this.createVertexTemplateEntry(s + 'HDI_AKS_Cluster.svg;',
			...
			this.createVertexTemplateEntry(s + 'IcM_Troubleshooting.svg;',
			...
			this.createVertexTemplateEntry(s + 'Intune_Trends.svg;',
					r * 0.142, r * 0.17, '', 'Intune Trends', null, null, this.getTagsForStencil(gn, 'intune trends', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Kubernetes_Fleet_Manager.svg;',
			...
			this.createVertexTemplateEntry(s + 'Marketplace_Management.svg;',
					r * 0.145, r * 0.17, '', 'Marketplace Management', null, null, this.getTagsForStencil(gn, 'marketplace management', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'MedTech_Service.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Network_Function_Manager_Functions.svg;',
			...
			this.createVertexTemplateEntry(s + 'Network_Security_Perimeters.svg;',
			...
			this.createVertexTemplateEntry(s + 'OSConfig.svg;',
			...
			this.createVertexTemplateEntry(s + 'Private_Endpoints.svg;',
			...
			this.createVertexTemplateEntry(s + 'Resource_Guard.svg;',
			...
			this.createVertexTemplateEntry(s + 'SCVMM_Management_Servers.svg;',
			...
			this.createVertexTemplateEntry(s + 'Storage_Actions.svg;',
					r * 0.17, r * 0.17, '', 'Storage Actions', null, null, this.getTagsForStencil(gn, 'storage actions', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_Storage_Mover.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_Sustainability.svg;',
					r * 0.17, r * 0.17, '', 'Support Sustainability', null, null, this.getTagsForStencil(gn, 'sustainability', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Targets_Management.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/azure_vmware_solution/AVS.svg;',
			...
			this.createVertexTemplateEntry(s + 'WAC_Installer.svg;',
			...
			this.createVertexTemplateEntry(s + 'Workspace_Gateway.svg;',
	...
	Sidebar.prototype.addAzure2SecurityPalette = function(gn, r, sb, s)
	{
		...
		var fns =
		[
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/Managed_Identities.svg;',
					r * 0.17, r * 0.165, '', 'AD Authentication Methods', null, null, this.getTagsForStencil(gn, 'ad authentication methods', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/Azure_AD_Identity_Protection.svg;',
					r * 0.17, r * 0.17, '', 'AD Identity Protection', null, null, this.getTagsForStencil(gn, 'ad identity protection', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/PIM.svg;',
			...
			this.createVertexTemplateEntry(s + 'Azure_AD_Risky_Signins.svg;',
					r * 0.1694, r * 0.17, '', 'AD Risky Signins', null, null, this.getTagsForStencil(gn, 'ad risky signins', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Azure_AD_Risky_Users.svg;',
			...
			this.createVertexTemplateEntry(s + 'Identity_Secure_Score.svg;',
					r * 0.1548, r * 0.17, '', 'Identity Secure Score', null, null, this.getTagsForStencil(gn, 'identity secure score', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/Azure_Information_Protection.svg;',
					r * 0.128, r * 0.17, '', 'Information Protection', null, null, this.getTagsForStencil(gn, 'information protection', dt).join(' ')),
			...
			this.createVertexTemplateEntry(s + 'MS_Defender_EASM.svg;',
					r * 0.1386, r * 0.17, '', 'MS Defender EASM', null, null, this.getTagsForStencil(gn, 'ms defender easm', dt).join(' ')),
			this.createVertexTemplateEntry(s + 'Multifactor_Authentication.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/identity/User_Settings.svg;',
					r * 0.17, r * 0.1423, '', 'User Settings', null, null, this.getTagsForStencil(gn, 'user settings', dt).join(' '))
		];
	...
	Sidebar.prototype.addAzure2WebPalette = function(gn, r, sb, s)
	{
		...
		[
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/App_Service_Certificates.svg;',
					r * 0.17, r * 0.155, '', 'App Service Certificates', null, null, this.getTagsForStencil(gn, 'app service certificates', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/App_Service_Domains.svg;',
					r * 0.17, r * 0.1375, '', 'App Service Domains', null, null, this.getTagsForStencil(gn, 'app service domains', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/App_Service_Environments.svg;',
					r * 0.17, r * 0.17, '', 'App Service Environments', null, null, this.getTagsForStencil(gn, 'app service environments', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/App_Service_Plans.svg;',
			...
			this.createVertexTemplateEntry(s + 'App_Space.svg;',
					r * 0.17, r * 0.17, '', 'App Space', null, null, this.getTagsForStencil(gn, 'app space', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/app_services/Search_Services.svg;',
					r * 0.17, r * 0.1228, '', 'Cognitive Search', null, null, this.getTagsForStencil(gn, 'cognitive search', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/ai_machine_learning/Cognitive_Services.svg;',
					r * 0.17, r * 0.12, '', 'Cognitive Services', null, null, this.getTagsForStencil(gn, 'cognitive services', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/networking/Front_Doors.svg;',
			...
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/compute/Azure_Spring_Cloud.svg;',
					r * 0.17, r * 0.17, '', 'Spring Apps', null, null, this.getTagsForStencil(gn, 'spring apps', dt).join(' ')),
			this.createVertexTemplateEntry('image;aspect=fixed;html=1;points=[];align=center;fontSize=12;image=img/lib/azure2/preview/Static_Apps.svg;',
