...
(function()
{
	...
	Menus.prototype.init = function()
	{
		...
		{
			editorUi.actions.put('insertFreehand', new Action('freehand' + '...', function()
			{
				if (graph.isEnabled())
				{
					...
					editorUi.freehandWindow.window.setVisible(true);
				}
									...
									if (editorUi.spinner.spin(document.body, mxResources.get('saving')))
									{
										...
										file.saveAs(newTitle, mxUtils.bind(this, function(resp)
										{
											...
											file.save(false, mxUtils.bind(this, function()
											{
												...
												editorUi.updateStatus(mxUtils.bind(this, function()
												{
