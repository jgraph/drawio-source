...
mxVertexHandler.prototype.updateLivePreview = function(me)
{
	...
	// Updates width and height placeholders in live preview
	var originalWidth = this.state.cell.geometry.width;
	var originalHeight = this.state.cell.geometry.height;
	this.state.cell.geometry.width = this.roundLength(this.bounds.width / scale);
	this.state.cell.geometry.height = this.roundLength(this.bounds.height / scale);

	// Draws the live preview
	this.state.view.graph.cellRenderer.redraw(this.state, true);
	
	// Restores original state
	this.state.cell.geometry.width = originalWidth;
	this.state.cell.geometry.height = originalHeight;
...
mxVertexHandler.prototype.redrawHandles = function()
{
	...
	if (s != null && this.sizers != null && this.sizers.length > 0 && this.sizers[0] != null)
	{
