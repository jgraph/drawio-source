...
mxOutline.prototype.updateSvg = function()
{
	...
	var color = mxUtils.getLightDarkColor((this.source.background == null ||
		this.source.background == mxConstants.NONE) ?
		this.source.defaultPageBackgroundColor : this.source.background).cssText;
